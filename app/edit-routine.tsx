  ...
  if (!routine) {
    return (
      <AppLayout style={styles.container}>
        <Text style={styles.errorText}>Rotina não encontrada.</Text>
      </AppLayout>
    );
  }
          ...
          routine.exercises.map((ex) => (
            <View key={ex.id} style={styles.exerciseCard}>
              ...
              >
                ...
                <Text style={styles.addSetText}>Adicionar Série</Text>
              </TouchableOpacity>
            </View>
          ))
        )}
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            <Text style={styles.modalTitle}>
              {editingExercise ? "Editar Exercício" : "Novo Exercício"}
            </Text>

            <TextInput
              value={newExerciseName}
              onChangeText={setNewExerciseName}
              placeholder="Nome do exercício"
